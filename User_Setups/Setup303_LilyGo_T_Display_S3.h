...
// Correct pins for LilyGO T-Display S3 (170x320)
#define TFT_MISO -1     // Not connected (display is write-only)
#define TFT_MOSI  11    // SDA/MOSI pin  
#define TFT_SCLK  12    // SCL/SCLK pin
...
// Tell the library to use 8-bit parallel mode (otherwise SPI is assumed)
// IMPORTANT: LilyGO T-Display S3 uses 8-bit parallel, NOT SPI!
#define TFT_PARALLEL_8_BIT
