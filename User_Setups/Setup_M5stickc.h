...
// connect MISO as some displays do not tristate that line wjen chip select is
// high! On NodeMCU 1.0 SD0=MISO, SD1=MOSI, CLK=SCLK to connect to TFT in
// overlap mode On NodeMCU V3  S0 =MISO, S1 =MOSI, S2 =SCLK In ESP8266 overlap
// mode the following must be defined
